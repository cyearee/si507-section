class Beverage():
    def __init__(self, beverage_name, cost,t_ype='unknown'):
        self.name = beverage_name
        self.cost = cost
        self.type = t_ype

    def write_row(self):
        return '{},{},{}\n'.format(self.name,str(self.cost),self.type)
...
if __name__=='__main__':
    ...
    with open('menu.csv','w') as menu:
        menu.write('Name,Cost,Type\n')
        menu.write(seltzer.write_row())
        menu.write(arabica.write_row())
        menu.write(robusta.write_row())